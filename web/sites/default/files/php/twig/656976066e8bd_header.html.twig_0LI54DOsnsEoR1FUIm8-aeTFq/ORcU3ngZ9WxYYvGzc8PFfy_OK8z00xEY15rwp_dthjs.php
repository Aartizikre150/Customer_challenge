...
class __TwigTemplate_0616aeb16836adb93a9707b82a2aa3f8 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_front"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "page_header", [], "any", false, false, true, 35))) {
    ...
    {
        return new Source("", "@xara/template-parts/header.html.twig", "C:\\xampp\\htdocs\\Customer_challenge\\web\\themes\\contrib\\xara\\templates\\template-parts\\header.html.twig");
    }
