...
class __TwigTemplate_83cf0bf5f089bf27f22bd6d72c49d45d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 15)) {
                    ...
                    echo "</a><span><i class=\"icon-angle-right\"></i></span>
        ";
                } else {
                    // line 18
                    echo "          ";
...
";
    ...
    {
        return new Source("", "themes/contrib/thex/templates/navigation/breadcrumb.html.twig", "C:\\xampp\\htdocs\\Customer_challenge\\web\\themes\\contrib\\thex\\templates\\navigation\\breadcrumb.html.twig");
    }
